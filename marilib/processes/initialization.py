...
def cg_range_optimization():
    # Wing position, HTP area and VTP area optimized according to HQ criteria,
    # 0: no, 1:yes
    cg_range_optimization_i = 0
...
def efficiency_fan():
    # efficiency to convert shaft power into kinetic energy
    efficiency_fan_i = 0.95
...
def efficiency_prop():
    # efficiency of a fan to convert shaft power into propulsive power
    efficiency_prop_i = 0.82
    return efficiency_prop_i


#=========================================================================
def propeller_efficiency():
    # efficiency of a propeller to convert shaft power into propulsive power
    propeller_efficiency_i = 0.85
...
def reference_thrust(n_pax_ref, design_range, n_engine):
    reference_thrust_i = (
        1.e5 + 177. * n_pax_ref * design_range * 1.e-6) / n_engine
...
def core_thrust_ratio():
    # Mean contribution of the core to the total thrust
    core_thrust_ratio_i = 0.13
...
def core_width_ratio():
    # Ratio of core mean diameter over fan diameter
    core_width_ratio_i = 0.70
...
def core_weight_ratio():
    # Mean contribution of the core to the total engine weight
    core_weight_ratio_i = 0.13
    return core_weight_ratio_i


#=========================================================================
def prop_architecture():
    # prop_architecture, TF: turbofan, PTE1: partial turbo electric 1
    prop_architecture_i = "TF"
...
def battery_strategy():
    # Battery sizing strategy, 1: power_feed & energy_cruise driven, 2:
    # battery mass driven
    battery_strategy_i = 1
...
def battery_power_feed():
    # Power delivered to e-fan(s) at take off and(or) climb during a total of
    # time_feed
    battery_power_feed_i = 0.
...
def battery_time_feed():
    # Maximum duration of the power_feed delivered to e-fan(s)
    battery_time_feed_i = unit.s_min(15.)
...
def battery_energy_density():
    ...
    battery_energy_density_i = unit.J_kWh(0.2)
...
def battery_power_density():
    # Battery power density (capability to release power per mass unit
    battery_power_density_i = 1.e3
...
def battery_fill_factor():
    # Ratio of available wing box volume used for batteries
    battery_fill_factor_i = 0.35
...
def e_chain_efficiency():
    # Overall efficiency of the electric chain, from generator to motor
    e_chain_efficiency_i = 0.90
...
def cost_mission_range(design_range):
    if(design_range < unit.m_NM(4500.)):
        cost_mission_range_i = unit.m_NM(800.)
    elif(design_range < unit.m_NM(6500.)):
        cost_mission_range_i = unit.m_NM(2000.)
    else:
        cost_mission_range_i = unit.m_NM(4000.)
