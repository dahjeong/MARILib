...
def max_path(aircraft, nei, altp, disa, speed_mode, mass, rating):
    ...
    #=========================================================================
    def fct_max_path(
            cz, aircraft, nei, altp, disa, speed_mode, mass, rating, isformax):
        pamb, tamb, tstd, dtodz = earth.atmosphere(altp, disa)
...
#=========================================================================
def propulsion_ceiling(
        aircraft, altp_ini, nei, vzreq, disa, speed_mode, speed, mass, rating):
    """
    Optimizes the speed of the aircraft to maximize the air path
    """

    #=========================================================================
    def fct_prop_ceiling(
            altp, aircraft, nei, vzreq, disa, speed_mode, speed, mass, rating):
        [slope, vz] = air_path(
            aircraft, nei, altp, disa, speed_mode, speed, mass, rating)
        delta_vz = vz - vzreq
        return delta_vz
